...
public class OutOfBoundsFirstArgumrntException extends Exception{
    private int lineNumber;
    private String wrongStatement;

    public OutOfBoundsFirstArgumrntException(int lineNumber, String wrongStatement){
...
//        return "Statement at line "+this.getLineNumber()+" "+ this.getWrongStatement();
        return "First argument is out of bounds in statement: "+ wrongStatement + " at line: " + lineNumber ;
    }
