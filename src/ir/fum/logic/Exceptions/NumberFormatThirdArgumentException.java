...
public class NumberFormatThirdArgumentException extends NumberFormatException {
    private int lineNumber;
    private String wrongStatement;

    public NumberFormatThirdArgumentException(int lineNumber, String wrongStatement) {
...
//        return "Statement at line "+this.getLineNumber()+" "+ this.getWrongStatement();
        return "Third argument is not a suitable input in statement: " + wrongStatement + " at line: " + lineNumber;
    }
